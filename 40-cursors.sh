...
#sudo find /usr/share/icons/default/ -name "index.theme" -exec sed -i 's/Bibata-Modern-Classic/Bibata-Modern-Ice/g' {} \;
...
#sudo find /usr/share/icons/default/ -name "index.theme" -exec sed -i 's/Bibata-Modern-Classic/Catppuccin-Latte-Light-Cursors/g' {} \;
...
sudo find /usr/share/icons/default/ -name "index.theme" -exec sed -i 's/Bibata-Modern-Classic/Qogir-Cursors/g' {} \;
